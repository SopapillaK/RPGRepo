...
public class Menu : MonoBehaviourPunCallbacks, ILobbyCallbacks
{
    ...
    void SetScreen(GameObject screen)
    {
        ...
        // activate the reequested screen
    ...
    {
        // enable the menu button once we connect to the server
    ...
    void UpdateLobbyUI()
    {
        // enable to disable the start game button depending on if we're the host
